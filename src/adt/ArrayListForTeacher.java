...
public class ArrayListForTeacher<T> implements ListInterfaceForTeacher<T>, Serializable {

  private T[] array;
  private int numberOfEntries;
  private static final int DEFAULT_CAPACITY = 5;

  public ArrayListForTeacher() {
    this(DEFAULT_CAPACITY);
  }

  public ArrayListForTeacher(int initialCapacity) {
    numberOfEntries = 0;
